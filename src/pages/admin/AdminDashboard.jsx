...
function StatCard({ icon: Icon, label, value, colorIcon, colorBg, to }) {
  return (
    <Link
      to={to}
      className="group bg-white border border-gray-100 rounded-2xl p-4 sm:p-5 shadow-sm
    ...
    >
      ...
      <p className="mt-4 text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight leading-none">
        {value ?? "—"}
      </p>
      <p className="mt-1.5 text-xs sm:text-sm text-gray-400">{label}</p>
    </Link>
  );
}
...
function SectionError({ message }) {
  return (
    <div className="flex items-center gap-2 m-4 sm:m-5 px-4 py-3 rounded-xl
      ...
      <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          ...
          {data.ordersError ? (
            ...
            <div className="py-10 sm:py-14 text-center text-sm text-gray-400">
              ...
              {data.recentOrders.map((order) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-4">
                    ...
                    <span className="text-xs sm:text-sm font-semibold text-gray-900 tabular-nums whitespace-nowrap">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          ...
          {data.lowStock.length === 0 ? (
            <div className="py-10 sm:py-14 flex flex-col items-center gap-2 text-sm text-gray-400">
